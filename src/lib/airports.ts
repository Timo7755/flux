...
export const airports: Airport[] = [
  ...
  {
    iata: 'IVD',
    name: 'Nusantara International Airport',
    city: 'Nusantara',
    country: 'Indonesia',
  },
  {
  ...
  },
  {
    ...
    city: 'Mataiva Airport',
    country: 'PF',
  },
  {
    iata: 'MAU',
    name: 'Maupiti Airport',
    city: 'Maupiti Airport',
    country: 'PF',
  },
  {
    iata: 'MOZ',
  ...
  },
  {
    ...
    city: 'Takapoto Airport',
    country: 'PF',
  },
  {
    iata: 'TKX',
    name: 'Takaroa Airport',
    city: 'Takaroa Airport',
    country: 'PF',
  },
  ...
  },
  {
    ...
    city: 'Narathiwat Airport',
    country: 'Thailand',
  },
  {
    iata: 'PHY',
    name: 'Phetchabun Airport',
    city: 'Phetchabun Airport',
    country: 'Thailand',
  },
  {
    iata: 'PHS',
  ...
  { iata: 'ROI', name: 'Roi Et Airport', city: 'Roi Et', country: 'Thailand' },
  {
    ...
    city: 'Sakon Nakhon Airport',
    country: 'Thailand',
  },
  {
    iata: 'THS',
    name: 'Sukhothai Airport',
    city: 'Sukhothai Airport',
    country: 'Thailand',
  },
  {
    iata: 'URT',
...
export function searchAirports(query: string): Airport[] {
  ...
  function score(a: Airport): number {
    const hub = HUB_AIRPORTS.has(a.iata) ? 0 : 1
    if (a.iata.toLowerCase() === q) return 0
    if (a.iata.toLowerCase().startsWith(q)) return 1
    if (a.city.toLowerCase().startsWith(q)) return 2 + hub
    if (a.city.toLowerCase().includes(q)) return 4 + hub
    if (a.name.toLowerCase().includes(q)) return 6 + hub
    if (a.country.toLowerCase().includes(q)) return 8 + hub
    if (resolveCountry(a.country).toLowerCase().includes(q)) return 8 + hub
    return 99
  }
